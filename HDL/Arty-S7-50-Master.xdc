...
## Pmod Header JA
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { SCK }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]
...
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { SSEL }]; #IO_L5N_T0_D07_14 Sch=ja_n[2]
