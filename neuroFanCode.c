...
#define number_of_iterations 64
...
//print(y,M,1);
	/* BEGINNIG OF OMP ALGORITHM */
		...
		{
			*(x_hat + i)= 0;
			finded_index[i] = 99999; //Initialize with some value less than all
		...
		for ( ii = 0;ii < 6;ii++){
...

			{
				...
				float Acopy[M*number_of_finded], At[number_of_finded*M], A_square[number_of_finded*number_of_finded],
					Q[number_of_finded*number_of_finded], R[number_of_finded*number_of_finded], Qt[number_of_finded*number_of_finded],
					yQt[number_of_finded];
